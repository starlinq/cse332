...
function createTable()
{
    ...
    //
    var topics = [
                ["Introduction. History. Information Discovery.", 
                "Readings: [<a href='#book-RS14-3e'>book-RS14-3e</a>, ch.1]"],

                ["Introduction. Getting started with R.",
                "Readings: [slides], [free-ebooks], [<a href='#book-RS14-3e'>book-RS14-3e</a>, ch.1]"], 

                ["Overview of data science and R. Installing R and RStudio",
                "Readings: [slides], [free-ebooks], [<a href='#book-RS14-3e'>book-RS14-3e</a>, ch.1]"],

                ["Issues of visualization from different perspectives: data-centric view, task-centric view, domain-centric view, and information theoretic view",
                "<strong>HW1</strong>, Readings: [<a href='#book-RS14-3e'>book-RS14-3e</a>, ch.2]"],

                ["Issues of visualization. Understanding data types. Manipulating data.",
                "Readings: [<a href='#book-RS14-3e'>book-RS14-3e</a>, ch.2]"],

                ["Issues of visualization. Subsetting data. Summarizing data",
                "Readings: [<a href='#book-RS14-3e'>book-RS14-3e</a>, ch.2]"],

                ["Representation. Basic principles. Information visualization process. Basic plotting in R. Traditional data visualizations – boxplots, time plots, scatterplots, pie charts and bar charts.",
                "Readings: [<a href='#book-RS14-3e'>book-RS14-3e</a>]"],

                ["Representation. Techniques. Building and customizing graphs.",
                "Readings: [<a href='#book-RS14-3e'>book-RS14-3e</a>]"],

                ["Representation. Exploratory graphical analysis.",
                "<strong>HW2</strong>, Readings: [<a href='#book-RS14-3e'>book-RS14-3e</a>]"],

                ["Representation. Human perception.",
                "Readings: [<a href='#book-RS14-3e'>book-RS14-3e</a>]"],

                ["Representation. Interaction.",
                "Readings: [<a href='#book-RS14-3e'>book-RS14-3e</a>]"],

                ["Representation. Advanced plotting.",
                "Readings: [<a href='#book-RS14-3e'>book-RS14-3e</a>]"],

                ["Advanced Presentation. Human vision.",
                "<strong>Midterm Exam (ME)</strong>, Readings: [<a href='#book-RS14-3e'>book-RS14-3e</a>]"],

                ["Advanced Presentation. Presentation in space.",
                "<strong>HW3</strong>, Readings: [<a href='#book-RS14-3e'>book-RS14-3e</a>]"],

                ["Advanced Presentation. Temporal Consideration.",
                "Readings: [<a href='#book-RS14-3e'>book-RS14-3e</a>]"],

                ["Advanced Presentation. Presentation in space and time.",
                "Readings: [<a href='#book-RS14-3e'>book-RS14-3e</a>]"],

                ["Advanced Presentation. 3D plotting.",
                "Readings: [<a href='#book-RS14-3e'>book-RS14-3e</a>]"],
                ...
                "<strong>HW4</strong>, Readings: [<a href='#book-RS14-3e'>book-RS14-3e</a>]"],

                ["Interaction. From R to interactive charts and maps.",
                "Readings: [<a href='#book-RS14-3e'>book-RS14-3e</a>]"],
                ...
                ["Interaction. Iteration and animation – loops, GIFs, and videos.",
                "Readings: [<a href='#book-RS14-3e'>book-RS14-3e</a>]"],

                ["Interaction.",
                "<strong>HW5</strong>, Readings: [<a href='#book-RS14-3e'>book-RS14-3e</a>]"],

                ["Design. Multifunctioning elements. Data density. Aesthetics.",
                "Readings: [<a href='#book-RS14-3e'>book-RS14-3e</a>]"],

                ["Design. Steps and problems.",
                "Readings: [<a href='#book-RS14-3e'>book-RS14-3e</a>"],

                ["Design. Data mining and visualization.",
                "Readings: [<a href='#book-RS14-3e'>book-RS14-3e</a>]"],
